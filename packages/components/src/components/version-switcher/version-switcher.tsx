...
export function VersionSwitcher({
  ...
  return (
    <details className="relative">
      <summary className="inline-flex cursor-pointer list-none items-center gap-1.5 rounded-md border bg-background px-2.5 py-1 font-medium text-foreground text-sm hover:bg-accent">
        {active.label}
        {active.deprecated && (
          <span className="rounded bg-yellow-200 px-1 py-0.5 font-semibold text-[10px] text-yellow-900 uppercase tracking-wide dark:bg-yellow-800 dark:text-yellow-100">
            old
          </span>
        )}
