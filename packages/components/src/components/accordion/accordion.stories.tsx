...
export const Default: Story = {
  args: {
    ...
    children: (
      <div>
        <p>
          Doxa is a platform for creating beautiful documentation for your
          products.
        </p>
      </div>
    ),
...
export const DefaultOpen: Story = {
  args: {
    ...
    children: (
      <div>
        <p>To get started with Doxa, follow these steps:</p>
        <ol>
...
export const WithDescription: Story = {
  render: () => (
    <div className="max-w-2xl space-y-3">
      <Accordion
        defaultOpen={false}
        description="Learn how to install Doxa"
        title="Installation"
      >
        <p>Run the following command to install Doxa:</p>
        <pre className="rounded bg-stone-800 p-3">npm install -g doxa</pre>
      </Accordion>
      <Accordion
        defaultOpen={false}
        description="Configure your Doxa project"
        title="Configuration"
      >
        <p>
...
export const WithIcon: Story = {
  render: () => (
    <div className="max-w-2xl space-y-3">
      ...
      >
        <p>Get up and running with Doxa in under 5 minutes.</p>
      </Accordion>
      <Accordion
        defaultOpen={false}
...
export const AccordionGroupWithRichContent: Story = {
  ...
  "components": ["accordion", "badge"]
        ...
        >
          ...
          <pre className="overflow-x-auto rounded bg-stone-800 p-3 text-sm">
            {`import { Accordion } from '@doxa/components';
