# Contributing to Doxa Components

Thank you for your interest in contributing to Doxa Components! This document provides guidelines and information for contributors.
...
- Check the [existing issues](https://github.com/doxa-dev/doxa-components/issues) to avoid duplicates
- [Open a bug report](https://github.com/doxa-dev/doxa-components/issues/new?template=bug_report.md) using the template
...
- [Open a feature request](https://github.com/doxa-dev/doxa-components/issues/new?template=feature_request.md) using the template
...
- Open a [GitHub Discussion](https://github.com/doxa-dev/doxa-components/discussions)
- Check our [documentation](https://github.com/doxa-dev/doxa-components)
